...
using Helios.Zero.MultiTenancy.Demo;
...
namespace Helios.Zero.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(HeliosZeroConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
